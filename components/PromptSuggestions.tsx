    ...
    <div className="flex-1 flex flex-col items-center justify-center h-full p-4">
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold text-white tracking-tight">
            Codey <span className="text-xl">✨</span>
        </h1>
        <p className="text-gray-400 mt-2">Your friendly, chill coding buddy.</p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 w-full max-w-2xl">
        {suggestions.map((s) => (
          <button
            ...
            className="bg-white/5 p-4 rounded-lg text-left hover:bg-white/10 transition-colors border border-white/10 focus:outline-none focus:ring-2 focus:ring-purple-400"
          >
